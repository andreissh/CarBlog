...
const watchFilesTask = (done) => {
    ...
    watch(path.src.html, series(liveReload));
...
exports.default = series(cleanTask, series(cssTask, jsTask, fontsTask, imgTask), serveTask, watchFilesTask);

exports.build = series(cleanTask, series(cssTask, jsTask, fontsTask, imgTask));
